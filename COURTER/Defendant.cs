...
namespace CourtroomProject.COURTER
{
    ...
    public partial class Defendant
    {
        ...
        public int Defendant_ID { get; set; }
        [Required(ErrorMessage = "Required")]
        public string name_defend { get; set; }
        [Required(ErrorMessage = "Required")]
        public Nullable<int> age_defend { get; set; }
        [Required(ErrorMessage = "Required")]
        public Nullable<System.DateTime> DOB_defend { get; set; }
